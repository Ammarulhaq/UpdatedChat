...
import com.example.conversationlisting.adapters.Utils;
        ...
        if (APILevel>=19){
            ...
            // Local file was selected
                ...
                if (returnedPath == null || returnedPath.equals("")){
                    ...
                    pickiTCallbacks.PickiTonCompleteListener(returnedPath, false, false, false, Utils.errorReason(),extensionFromMime);
                }
                // Path is not null
                else {
                    // This can be caused by two situations
                    ...
                    pickiTCallbacks.PickiTonCompleteListener(returnedPath, false, false, true, "",extensionFromMime);
                }
            }
        }else{
            //Todo: Test API <19
