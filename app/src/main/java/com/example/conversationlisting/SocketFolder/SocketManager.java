package com.example.conversationlisting.SocketFolder;
...
public class SocketManager {
    ...
    public void connectSocket() {
        try {
            if(socket==null){
                String serverAddress = "https://staging.wurqi.com/";
                ...
                opts.secure = false;
              //  opts.query = "token=" + "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJjb21wYW55X2lkIjoiMTg4IiwiZW1haWwiOiJoYW1tYWRAd3VycWkuY29tIiwicmVzb3VyY2VfaWQiOjEzMiwiZXhwIjoxNTkyODE1OTYyfQ.ablSga3SyaV7YESEMwAfi0U23nnGHaWTDtRfgEwUDrE" + "&" + "user_id=" + 132;
